...
the algorithm searches these subareas to find a space in which the a box can fit. One or more of these "2D" layers are generated by the algorithm and "stacked" on top of
